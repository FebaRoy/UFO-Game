...
void greetings(std::string Name){
   ...
   std::cout<<"==================================================\n\n";
   std::cout<<"========Welcome, "<<Name<<" to the Alien World!========\n\n\n";
   std::cout<<"Instructions: Save your friend, Aleena from alien abduction!\n";
   std::cout << "Guess the letters in the codeword to save Aleena!\n";
}
